...
// MARK: - 2 mat4
UniformBufferM4::UniformBufferM4(int count) {
    glBindBuffer(GL_UNIFORM_BUFFER, ID);
    glBufferData (GL_UNIFORM_BUFFER, count * sizeof(glm::mat4), 0, GL_STATIC_DRAW);
...
UniformBuffer3f::UniformBuffer3f() {
    glBindBuffer(GL_UNIFORM_BUFFER, ID);
    glBufferData (GL_UNIFORM_BUFFER, sizeof(glm::vec3), 0, GL_STATIC_DRAW);
    glBindBuffer(GL_UNIFORM_BUFFER, 0);
}
